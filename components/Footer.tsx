            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-8 h-8 rounded-md border border-border flex items-center justify-center text-muted hover:text-foreground hover:border-accent/50 transition-all"
                >
                  {s.icon}
                </a>
              ))}
